  ...
  <div class="sales-board">
      ...
      <div class="sales-board-form">
          <div class="sales-board-line">
              ...
              <v-counter :max="50" :min="0" @on-change="changeHandler('buyNum',$event)"></v-counter>
              </div>
          </div>
          <div class="sales-board-line">
              <div class="sales-board-line-left">
              ...
              <div class="sales-board-line-right">
                  <v-multi-chooser :multichooses="versionList" @on-change="changeHandler('versionList',$event)"></v-multi-chooser>
              </div>
          </div>
          <div class="sales-board-line">
              <div class="sales-board-line-left">
